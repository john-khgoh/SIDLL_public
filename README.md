...
Given that it is always sorted by key, it can be used to keep track of metrics like the min/max (and their associated values), median, mean, head/tail of the linked list.
