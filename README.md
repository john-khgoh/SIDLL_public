...
Given that it is always sorted by key, it can be used to keep track of metrics like the (streaming) mean, median, head/tail as well as min/max (and their associated values) of the linked list. 
