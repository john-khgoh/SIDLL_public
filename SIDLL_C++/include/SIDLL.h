...
class ListNode {
public:
    ListNode(double key, variant<int, double, long, string, tuple<int, int>, tuple<int, int, int>, tuple<double, double>, tuple<double, double, double>, tuple<std::string, std::string>, tuple <std::string, std::string, std::string>> val);
    double getKey();
